  ...
  return (
    <header>
      ...
      <ul>
        ...
        {count > 49 && <li><Link partiallyActive={true} to="/tutorials" activeClassName="active">tutorials</Link></li>}
        {count > 49 && <li><Link partiallyActive={true} to="/blog" activeClassName="active">blog</Link></li>}
        {count > 49 && <li><Link partiallyActive={true} to="/projects" activeClassName="active">projects</Link></li>}
        {count > 49 && <li><Link partiallyActive={true} to="/lab" activeClassName="active">lab</Link></li>}
        ...
        {count > 49 && <li><Link partiallyActive={true} to="/about" activeClassName="active">about</Link></li>}
        {count > 49 && <li><Link partiallyActive={true} to="/contact" activeClassName="active">connect</Link></li>}
      </ul>
