    ...
    `).then(result => {
      ...
      articles.edges.forEach(({ node }, index) => {
        ...
        createPage({
          ...
          component: node.fields.slug.includes('mot-ket-thuc-khac') || node.fields.slug.includes('cai-anh-song-chung') ? path.resolve('./src/layout/blog.js') : path.resolve('./src/layout/blog-disabled.js'),
          context: {
